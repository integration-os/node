...
export class Products extends ClientSDK {
    ...
    async list(
        ...
        const context = { operationID: "get_/products" };
    ...
    async create(
        ...
        const context = { operationID: "post_/products" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
    ...
    async count(
        ...
        const context = { operationID: "get_/products/count" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
    ...
    async get(
        ...
        const context = { operationID: "get_/products/{id}" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
    ...
    async delete(
        ...
        const context = { operationID: "delete_/products/{id}" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
    ...
    async update(
        ...
        const context = { operationID: "patch_/products/{id}" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
