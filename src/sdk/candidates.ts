...
export class Candidates extends ClientSDK {
    ...
    async list(
        ...
        const context = { operationID: "get_/candidates" };
    ...
    async create(
        ...
        const context = { operationID: "post_/candidates" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
    ...
    async count(
        ...
        const context = { operationID: "get_/candidates/count" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
    ...
    async get(
        ...
        const context = { operationID: "get_/candidates/{id}" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
    ...
    async delete(
        ...
        const context = { operationID: "delete_/candidates/{id}" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
    ...
    async update(
        ...
        const context = { operationID: "patch_/candidates/{id}" };
        const doOptions = { context, errorCodes: ["4XX", "5XX"] };
        const request = await this.createRequest$(
            {
                context,
