...
export class Customers extends ClientSDK {
  ...
  async get(
    ...
    const payload$ =
      operations.GetCustomersIdRequest$.outboundSchema.parse(input$);
    const body$ = null;
  ...
  async delete(
    ...
    const payload$ =
      operations.DeleteCustomersIdRequest$.outboundSchema.parse(input$);
    const body$ = null;
  ...
  async update(
    ...
    const payload$ =
      operations.PatchCustomersIdRequest$.outboundSchema.parse(input$);
  ...
  async list(
    ...
    const payload$ =
      operations.GetCustomersRequest$.outboundSchema.parse(input$);
    const body$ = null;
  ...
  async create(
    ...
    const payload$ =
      operations.PostCustomersRequest$.outboundSchema.parse(input$);
  ...
  async count(
    ...
    const payload$ =
      operations.GetCustomersCountRequest$.outboundSchema.parse(input$);
    const body$ = null;
