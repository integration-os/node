...
export type Chats = {
    ...
    type?: ChatsType | undefined;
    status?: ChatsStatus | undefined;
...
/** @internal */
export const ChatsType$ = z.nativeEnum(ChatsType);

/** @internal */
export const ChatsStatus$ = z.nativeEnum(ChatsStatus);
    ...
    export const inboundSchema: z.ZodType<Chats, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            updatedAt: z
                ...
                .transform((v) => new Date(v))
                .optional(),
            type: ChatsType$.optional(),
            status: ChatsStatus$.optional(),
