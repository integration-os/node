...
export namespace PatchAccountsIdUnified$ {
    ...
    export const inboundSchema: z.ZodType<PatchAccountsIdUnified, z.ZodTypeDef, Inbound> = z.object(
        {}
    );

    export type Outbound = {};

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, PatchAccountsIdUnified> =
        z.object({});
}
