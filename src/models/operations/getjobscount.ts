...
export enum GetJobsCountStatusCode {
    TwoHundred = 200,
    FourHundred = 400,
    FiveHundred = 500,
}
...
export type GetJobsCountResponseBody = {
    ...
    statusCode?: GetJobsCountStatusCode | undefined;
...
/** @internal */
export const GetJobsCountStatusCode$ = z.nativeEnum(GetJobsCountStatusCode);
...
export namespace GetJobsCountResponseBody$ {
    ...
    export const inboundSchema: z.ZodType<GetJobsCountResponseBody, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            statusCode: GetJobsCountStatusCode$.optional(),
