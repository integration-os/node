...
export type GetTicketsResponseBody = {
    ...
    unified?: Array<components.Tickets> | undefined;
...
export namespace GetTicketsResponseBody$ {
    export type Inbound = {
        status?: string | undefined;
        statusCode?: number | undefined;
        unified?: Array<components.Tickets$.Inbound> | undefined;
    ...
    export const inboundSchema: z.ZodType<GetTicketsResponseBody, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            unified: z.array(components.Tickets$?.inboundSchema).optional(),
    ...
    export type Outbound = {
        status?: string | undefined;
        statusCode?: number | undefined;
        unified?: Array<components.Tickets$.Outbound> | undefined;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetTicketsResponseBody> = z
        .object({
            status: z.string().optional(),
            statusCode: z.number().int().optional(),
            unified: z.array(components.Tickets$?.outboundSchema).optional(),
