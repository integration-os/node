...
export type GetCandidatesCountRequest = {
    /**
...
export type GetCandidatesCountPassthrough = {};
...
export type GetCandidatesCountResponse = {
    /**
     ...
     * Successful response
     */
    object?: GetCandidatesCountResponseBody | undefined;
};

/** @internal */
export namespace GetCandidatesCountRequest$ {
    export type Inbound = {
    ...
    export const inboundSchema: z.ZodType<GetCandidatesCountRequest, z.ZodTypeDef, Inbound> = z
        .object({
...
export namespace GetCandidatesCountUnified$ {
    ...
    export const inboundSchema: z.ZodType<GetCandidatesCountUnified, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCandidatesCountUnified> = z
        .object({
            count: z.number().int().optional(),
        })
        .transform((v) => {
...
/** @internal */
export namespace GetCandidatesCountPassthrough$ {
    export type Inbound = {};

    export const inboundSchema: z.ZodType<GetCandidatesCountPassthrough, z.ZodTypeDef, Inbound> =
        z.object({});

    export type Outbound = {};

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCandidatesCountPassthrough> =
        z.object({});
}

/** @internal */
export namespace GetCandidatesCountCache$ {
    export type Inbound = {
        hit?: boolean | undefined;
        ttl?: number | undefined;
    };
...
/** @internal */
export namespace GetCandidatesCountMeta$ {
    export type Inbound = {
        timestamp?: number | undefined;
        latency?: number | undefined;
        platformRateLimitRemaining?: number | undefined;
...
export namespace GetCandidatesCountResponseBody$ {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCandidatesCountResponseBody> =
        z
            .object({
                status: z.string().optional(),
                statusCode: z.number().int().optional(),
...
/** @internal */
export namespace GetCandidatesCountResponse$ {
    export type Inbound = {
        ContentType: string;
        StatusCode: number;
        RawResponse: Response;
        object?: GetCandidatesCountResponseBody$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<GetCandidatesCountResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export type Outbound = {
        ...
        StatusCode: number;
        RawResponse: never;
        object?: GetCandidatesCountResponseBody$.Outbound | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCandidatesCountResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
