...
export namespace PatchContactsIdUnified$ {
    ...
    export const inboundSchema: z.ZodType<PatchContactsIdUnified, z.ZodTypeDef, Inbound> = z.object(
        {}
    );

    export type Outbound = {};

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, PatchContactsIdUnified> =
        z.object({});
}
