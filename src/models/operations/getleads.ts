...
export type GetLeadsResponseBody = {
    ...
    unified?: Array<components.Leads> | undefined;
...
export namespace GetLeadsResponseBody$ {
    export type Inbound = {
        status?: string | undefined;
        statusCode?: number | undefined;
        unified?: Array<components.Leads$.Inbound> | undefined;
    ...
    export const inboundSchema: z.ZodType<GetLeadsResponseBody, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            unified: z.array(components.Leads$?.inboundSchema).optional(),
    ...
    export type Outbound = {
        status?: string | undefined;
        statusCode?: number | undefined;
        unified?: Array<components.Leads$.Outbound> | undefined;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetLeadsResponseBody> = z
        .object({
            status: z.string().optional(),
            statusCode: z.number().int().optional(),
            unified: z.array(components.Leads$?.outboundSchema).optional(),
