...
export type GetCandidatesResponseBody = {
    ...
    unified?: Array<components.Candidates> | undefined;
...
export namespace GetCandidatesResponseBody$ {
    export type Inbound = {
        status?: string | undefined;
        statusCode?: number | undefined;
        unified?: Array<components.Candidates$.Inbound> | undefined;
    ...
    export const inboundSchema: z.ZodType<GetCandidatesResponseBody, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            unified: z.array(components.Candidates$?.inboundSchema).optional(),
    ...
    export type Outbound = {
        status?: string | undefined;
        statusCode?: number | undefined;
        unified?: Array<components.Candidates$.Outbound> | undefined;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCandidatesResponseBody> = z
        .object({
            status: z.string().optional(),
            statusCode: z.number().int().optional(),
            unified: z.array(components.Candidates$?.outboundSchema).optional(),
