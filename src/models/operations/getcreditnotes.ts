...
export type GetCreditNotesPassthrough = {};

export type GetCreditNotesCache = {
...
export type GetCreditNotesMeta = {
    ...
    cache?: GetCreditNotesCache | undefined;
};
...
export type GetCreditNotesResponseBody = {
    ...
    unified?: Array<components.CreditNotes> | undefined;
    pagination?: GetCreditNotesPagination | undefined;
    passthrough?: GetCreditNotesPassthrough | undefined;
    meta?: GetCreditNotesMeta | undefined;
};
...
export namespace GetCreditNotesRequest$ {
    ...
    export const inboundSchema: z.ZodType<GetCreditNotesRequest, z.ZodTypeDef, Inbound> = z
        .object({
...
/** @internal */
export namespace GetCreditNotesPagination$ {
    export type Inbound = {
        nextCursor?: string | undefined;
        previousCursor?: string | undefined;
        limit?: number | undefined;
    ...
    export const inboundSchema: z.ZodType<GetCreditNotesPagination, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCreditNotesPagination> = z
        .object({
            nextCursor: z.string().optional(),
            previousCursor: z.string().optional(),
            limit: z.number().int().optional(),
...
/** @internal */
export namespace GetCreditNotesPassthrough$ {
    export type Inbound = {};

    export const inboundSchema: z.ZodType<GetCreditNotesPassthrough, z.ZodTypeDef, Inbound> =
        z.object({});

    export type Outbound = {};

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCreditNotesPassthrough> =
        z.object({});
}

/** @internal */
export namespace GetCreditNotesCache$ {
    export type Inbound = {
        hit?: boolean | undefined;
        ttl?: number | undefined;
    };

    export const inboundSchema: z.ZodType<GetCreditNotesCache, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCreditNotesCache> = z
        .object({
            hit: z.boolean().optional(),
            ttl: z.number().int().optional(),
        })
...
/** @internal */
export namespace GetCreditNotesMeta$ {
    export type Inbound = {
        timestamp?: number | undefined;
        latency?: number | undefined;
        platformRateLimitRemaining?: number | undefined;
        ...
        key?: string | undefined;
        heartbeats?: Array<string> | undefined;
        cache?: GetCreditNotesCache$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<GetCreditNotesMeta, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            cache: z.lazy(() => GetCreditNotesCache$?.inboundSchema).optional(),
        })
        .transform((v) => {
            return {
    ...
    export type Outbound = {
        ...
        key?: string | undefined;
        heartbeats?: Array<string> | undefined;
        cache?: GetCreditNotesCache$.Outbound | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCreditNotesMeta> = z
        .object({
            timestamp: z.number().int().optional(),
            latency: z.number().int().optional(),
            platformRateLimitRemaining: z.number().int().optional(),
            ...
            key: z.string().optional(),
            heartbeats: z.array(z.string()).optional(),
            cache: z.lazy(() => GetCreditNotesCache$?.outboundSchema).optional(),
        })
        .transform((v) => {
            return {
                ...(v.timestamp === undefined ? null : { timestamp: v.timestamp }),
...
export namespace GetCreditNotesResponseBody$ {
    export type Inbound = {
        status?: string | undefined;
        statusCode?: number | undefined;
        unified?: Array<components.CreditNotes$.Inbound> | undefined;
        pagination?: GetCreditNotesPagination$.Inbound | undefined;
        passthrough?: GetCreditNotesPassthrough$.Inbound | undefined;
        meta?: GetCreditNotesMeta$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<GetCreditNotesResponseBody, z.ZodTypeDef, Inbound> = z
        .object({
            status: z.string().optional(),
            statusCode: z.number().int().optional(),
            unified: z.array(components.CreditNotes$?.inboundSchema).optional(),
            pagination: z.lazy(() => GetCreditNotesPagination$?.inboundSchema).optional(),
            passthrough: z.lazy(() => GetCreditNotesPassthrough$?.inboundSchema).optional(),
            meta: z.lazy(() => GetCreditNotesMeta$?.inboundSchema).optional(),
        })
        .transform((v) => {
            return {
    ...
    export type Outbound = {
        status?: string | undefined;
        statusCode?: number | undefined;
        unified?: Array<components.CreditNotes$.Outbound> | undefined;
        pagination?: GetCreditNotesPagination$.Outbound | undefined;
        passthrough?: GetCreditNotesPassthrough$.Outbound | undefined;
        meta?: GetCreditNotesMeta$.Outbound | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCreditNotesResponseBody> = z
        .object({
            status: z.string().optional(),
            statusCode: z.number().int().optional(),
            unified: z.array(components.CreditNotes$?.outboundSchema).optional(),
            pagination: z.lazy(() => GetCreditNotesPagination$?.outboundSchema).optional(),
            passthrough: z.lazy(() => GetCreditNotesPassthrough$?.outboundSchema).optional(),
            meta: z.lazy(() => GetCreditNotesMeta$?.outboundSchema).optional(),
        })
        .transform((v) => {
            return {
                ...(v.status === undefined ? null : { status: v.status }),
...
export namespace GetCreditNotesResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        object?: GetCreditNotesResponseBody$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<GetCreditNotesResponse, z.ZodTypeDef, Inbound> = z
        .object({
